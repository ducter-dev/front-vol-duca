<template>
  <div class="m-2 sm:mx-12 sm:my-2 w-full flex flex-col">
    <div class="flex flex-row justify-start items-center mt-5 ml-5 md:ml-0">
      <div class="flex justify-center items-center mr-2">
        <h2 class="flex justify-center items-center text-xl font-bold text-dark mr-2">Editar Empresa</h2>
      </div>
        <button
          type="button"
          class="
    ...
    <div class="flex justify-center items-center my-7 md:my-4 mb-16">
...
import useEmpresa from '../../../modules/empresas/composables/empresa'
